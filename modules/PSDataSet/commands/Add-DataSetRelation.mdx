---
id: Add-DataSetRelation
title: Add-DataSetRelation
description: Help page for the Powershell "Add-DataSetRelation" command
keywords:
  - Powershell
  - PSDataSet
  - Help
...
Add-DataSetRelation [-DataSet] <DataSet> [-ParentDataTableColumn] <DataColumn>
 [-ChildDataTableColumn] <DataColumn> [-RelationName] <String> [-Passtrough]
