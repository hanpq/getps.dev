---
id: Get-LoggingDefaultFormat
title: Get-LoggingDefaultFormat
description: Help page for the Powershell "Get-LoggingDefaultFormat" command
keywords:
  - Powershell
  - PSLogs
  - Help
...
```powershell
Get-LoggingDefaultFormat [-ProgressAction <ActionPreference>] [<CommonParameters>]
```
