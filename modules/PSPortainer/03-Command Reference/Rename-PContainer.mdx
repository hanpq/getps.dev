---
id: Rename-PContainer
title: Rename-PContainer
description: Help page for the Powershell "Rename-PContainer" command
keywords:
  - Powershell
  - PSPortainer
  - Help
...
Rename-PContainer [[-Endpoint] <String>] [[-Id] <Object[]>] [[-Session] <PortainerSession>]
 [[-NewName] <String>] [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm] [<CommonParameters>]
```
