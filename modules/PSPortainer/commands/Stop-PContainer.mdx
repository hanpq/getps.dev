---
id: Stop-PContainer
title: Stop-PContainer
description: Help page for the Powershell "Stop-PContainer" command
keywords:
  - Powershell
  - PSPortainer
  - Help
...
```powershell
Stop-PContainer [[-Endpoint] <String>] [[-Id] <Object[]>] [[-Session] <PortainerSession>] [-Kill]
