---
id: Start-PContainer
title: Start-PContainer
description: Help page for the Powershell "Start-PContainer" command
keywords:
  - Powershell
  - PSPortainer
  - Help
...
```powershell
Start-PContainer [[-Endpoint] <String>] [[-Id] <Object[]>] [[-Session] <PortainerSession>]
