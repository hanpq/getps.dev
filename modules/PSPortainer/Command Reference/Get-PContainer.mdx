...
```powershell
Get-PContainer [-Endpoint <String>] [-Session <PortainerSession>] [-ProgressAction <ActionPreference>]
 [<CommonParameters>]
```
...
```powershell
Get-PContainer [-Endpoint <String>] [-Id <Object[]>] [-Session <PortainerSession>]
