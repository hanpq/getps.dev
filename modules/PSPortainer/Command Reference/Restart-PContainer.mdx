---
id: Restart-PContainer
title: Restart-PContainer
description: Help page for the Powershell "Restart-PContainer" command
keywords:
  - Powershell
  - PSPortainer
  - Help
...
```powershell
Restart-PContainer [[-Endpoint] <String>] [[-Id] <Object[]>] [[-Session] <PortainerSession>]
