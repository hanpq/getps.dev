---
id: Wait-PContainer
title: Wait-PContainer
description: Help page for the Powershell "Wait-PContainer" command
keywords:
  - Powershell
  - PSPortainer
  - Help
...
Wait-PContainer [[-Endpoint] <String>] [[-Id] <Object[]>] [[-Session] <PortainerSession>]
 [[-Condition] <ContainerCondition>] [-ProgressAction <ActionPreference>] [<CommonParameters>]
```
