---
id: Resume-PContainer
title: Resume-PContainer
description: Help page for the Powershell "Resume-PContainer" command
keywords:
  - Powershell
  - PSPortainer
  - Help
...
```powershell
Resume-PContainer [[-Endpoint] <String>] [[-Id] <Object[]>] [[-Session] <PortainerSession>]
