---
id: Resize-PContainerTTY
title: Resize-PContainerTTY
description: Help page for the Powershell "Resize-PContainerTTY" command
keywords:
  - Powershell
  - PSPortainer
  - Help
...
Resize-PContainerTTY [[-Endpoint] <String>] [[-Id] <Object[]>] [[-Session] <PortainerSession>]
 [[-Height] <Int32>] [[-Width] <Int32>] [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
