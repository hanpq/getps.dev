---
id: Get-IMServerFeature
title: Get-IMServerFeature
description: Help page for the Powershell "Get-IMServerFeature" command
keywords:
  - Powershell
  - PSImmich
  - Help
...
```powershell
Get-IMServerFeature [[-Session] <ImmichSession>] [-ProgressAction <ActionPreference>] [<CommonParameters>]
```
