---
id: Get-IMServerConfig
title: Get-IMServerConfig
description: Help page for the Powershell "Get-IMServerConfig" command
keywords:
  - Powershell
  - PSImmich
  - Help
...
```powershell
Get-IMServerConfig [[-Session] <ImmichSession>] [-ProgressAction <ActionPreference>] [<CommonParameters>]
```
