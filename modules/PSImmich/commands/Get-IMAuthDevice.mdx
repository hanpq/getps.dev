---
id: Get-IMAuthDevice
title: Get-IMAuthDevice
description: Help page for the Powershell "Get-IMAuthDevice" command
keywords:
  - Powershell
  - PSImmich
  - Help
...
```powershell
Get-IMAuthDevice [[-Session] <ImmichSession>] [-ProgressAction <ActionPreference>] [<CommonParameters>]
```
