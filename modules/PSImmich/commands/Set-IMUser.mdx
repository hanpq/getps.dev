...
```powershell
Set-IMUser [[-Session] <ImmichSession>] [-id] <String[]> [[-Email] <String>] [[-AvatarColor] <String>]
 [[-MemoriesEnabled] <Boolean>] [[-Name] <String>] [[-Password] <SecureString>] [[-QuotaSizeInBytes] <Int64>]
 [[-ShouldChangePassword] <Boolean>] [[-StorageLabel] <String>] [[-IsAdmin] <Boolean>]
