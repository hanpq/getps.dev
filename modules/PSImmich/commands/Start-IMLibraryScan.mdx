---
id: Start-IMLibraryScan
title: Start-IMLibraryScan
description: Help page for the Powershell "Start-IMLibraryScan" command
keywords:
  - Powershell
  - PSImmich
  - Help
...
```powershell
Start-IMLibraryScan [-Session <ImmichSession>] [-refreshAllFiles <Boolean>] [-refreshModifiedFiles <Boolean>]
...
```powershell
Start-IMLibraryScan [-Session <ImmichSession>] -id <String[]> [-refreshAllFiles <Boolean>]
