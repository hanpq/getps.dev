---
id: Get-IMServerStorage
title: Get-IMServerStorage
description: Help page for the Powershell "Get-IMServerStorage" command
keywords:
  - Powershell
  - PSImmich
  - Help
...
```powershell
Get-IMServerStorage [[-Session] <ImmichSession>] [-ProgressAction <ActionPreference>] [<CommonParameters>]
```
