---
id: Restore-IMUser
title: Restore-IMUser
description: Help page for the Powershell "Restore-IMUser" command
keywords:
  - Powershell
  - PSImmich
  - Help
...
```powershell
Restore-IMUser [[-Session] <ImmichSession>] [-id] <String[]> [-ProgressAction <ActionPreference>]
 [<CommonParameters>]
```
