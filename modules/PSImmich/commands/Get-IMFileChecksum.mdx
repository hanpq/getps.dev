---
id: Get-IMFileChecksum
title: Get-IMFileChecksum
description: Help page for the Powershell "Get-IMFileChecksum" command
keywords:
  - Powershell
  - PSImmich
  - Help
...
```powershell
Get-IMFileChecksum [[-Session] <ImmichSession>] [-FileName] <String[]> [-ProgressAction <ActionPreference>]
 [<CommonParameters>]
```
