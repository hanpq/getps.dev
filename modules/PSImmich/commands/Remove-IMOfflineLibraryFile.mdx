---
id: Remove-IMOfflineLibraryFile
title: Remove-IMOfflineLibraryFile
description: Help page for the Powershell "Remove-IMOfflineLibraryFile" command
keywords:
  - Powershell
  - PSImmich
  - Help
...
```powershell
Remove-IMOfflineLibraryFile [-Session <ImmichSession>] [-ProgressAction <ActionPreference>] [-WhatIf]
...
```powershell
Remove-IMOfflineLibraryFile [-Session <ImmichSession>] -id <String[]> [-ProgressAction <ActionPreference>]
