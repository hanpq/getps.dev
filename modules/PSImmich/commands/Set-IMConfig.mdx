...
id: Set-IMConfig
title: Set-IMConfig
description: Help page for the Powershell "Set-IMConfig" command
keywords:
  - Powershell
  - PSImmich
  - Help
...
```powershell
Set-IMConfig [[-Session] <ImmichSession>] [[-RawJSON] <String>] [-ProgressAction <ActionPreference>] [-WhatIf]
...
Defines the immich configuration.
Provided as JSON text.
