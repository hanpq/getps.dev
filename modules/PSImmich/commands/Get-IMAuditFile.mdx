---
id: Get-IMAuditFile
title: Get-IMAuditFile
description: Help page for the Powershell "Get-IMAuditFile" command
keywords:
  - Powershell
  - PSImmich
  - Help
...
```powershell
Get-IMAuditFile [[-Session] <ImmichSession>] [-ProgressAction <ActionPreference>] [<CommonParameters>]
```
