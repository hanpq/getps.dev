---
id: Get-IMRandomAsset
title: Get-IMRandomAsset
description: Help page for the Powershell "Get-IMRandomAsset" command
keywords:
  - Powershell
  - PSImmich
  - Help
...
```powershell
Get-IMRandomAsset [[-Session] <ImmichSession>] [[-Count] <Int32>] [-ProgressAction <ActionPreference>]
 [<CommonParameters>]
```
