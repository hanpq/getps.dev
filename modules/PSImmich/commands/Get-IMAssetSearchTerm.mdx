---
id: Get-IMAssetSearchTerm
title: Get-IMAssetSearchTerm
description: Help page for the Powershell "Get-IMAssetSearchTerm" command
keywords:
  - Powershell
  - PSImmich
  - Help
...
```powershell
Get-IMAssetSearchTerm [[-Session] <ImmichSession>] [-ProgressAction <ActionPreference>] [<CommonParameters>]
```
