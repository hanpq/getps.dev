---
id: Add-IMAlbumAsset
title: Add-IMAlbumAsset
description: Help page for the Powershell "Add-IMAlbumAsset" command
keywords:
  - Powershell
  - PSImmich
  - Help
...
```powershell
Add-IMAlbumAsset [[-Session] <ImmichSession>] [-albumId] <String> [-assetId] <String[]>
