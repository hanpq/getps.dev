---
id: Get-IMCuratedLocation
title: Get-IMCuratedLocation
description: Help page for the Powershell "Get-IMCuratedLocation" command
keywords:
  - Powershell
  - PSImmich
  - Help
...
```powershell
Get-IMCuratedLocation [[-Session] <ImmichSession>] [-ProgressAction <ActionPreference>] [<CommonParameters>]
```
