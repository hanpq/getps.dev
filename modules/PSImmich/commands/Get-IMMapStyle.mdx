---
id: Get-IMMapStyle
title: Get-IMMapStyle
description: Help page for the Powershell "Get-IMMapStyle" command
keywords:
  - Powershell
  - PSImmich
  - Help
...
```powershell
Get-IMMapStyle [-Session <ImmichSession>] [-Theme <String>] [-ProgressAction <ActionPreference>]
 [<CommonParameters>]
```
