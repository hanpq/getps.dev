---
id: Get-IMServerAbout
title: Get-IMServerAbout
description: Help page for the Powershell "Get-IMServerAbout" command
keywords:
  - Powershell
  - PSImmich
  - Help
...
```powershell
Get-IMServerAbout [[-Session] <ImmichSession>] [-ProgressAction <ActionPreference>] [<CommonParameters>]
```
