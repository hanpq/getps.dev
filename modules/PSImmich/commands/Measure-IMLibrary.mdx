---
id: Measure-IMLibrary
title: Measure-IMLibrary
description: Help page for the Powershell "Measure-IMLibrary" command
keywords:
  - Powershell
  - PSImmich
  - Help
...
```powershell
Measure-IMLibrary [-Session <ImmichSession>] [-ProgressAction <ActionPreference>] [<CommonParameters>]
```

### id

```powershell
Measure-IMLibrary [-Session <ImmichSession>] -id <String[]> [-ProgressAction <ActionPreference>]
 [<CommonParameters>]
```
