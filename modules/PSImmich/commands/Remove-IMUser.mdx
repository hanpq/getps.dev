...
id: Remove-IMUser
title: Remove-IMUser
description: Help page for the Powershell "Remove-IMUser" command
keywords:
  - Powershell
  - PSImmich
  - Help
...
```powershell
Remove-IMUser [[-Session] <ImmichSession>] [-id] <String[]> [-Force] [-ProgressAction <ActionPreference>]
...
Defines that the user should be removed immediatly.
By default the user remains in trash for 7 days before assets are removed.
