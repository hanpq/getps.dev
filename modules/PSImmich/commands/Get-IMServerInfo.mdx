---
id: Get-IMServerInfo
title: Get-IMServerInfo
description: Help page for the Powershell "Get-IMServerInfo" command
keywords:
  - Powershell
  - PSImmich
  - Help
...
```powershell
Get-IMServerInfo [[-Session] <ImmichSession>] [-ProgressAction <ActionPreference>] [<CommonParameters>]
```
