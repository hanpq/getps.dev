---
id: Update-IMAsset
title: Update-IMAsset
description: Help page for the Powershell "Update-IMAsset" command
keywords:
  - Powershell
  - PSImmich
  - Help
...
```powershell
Update-IMAsset [-Session <ImmichSession>] -ids <String[]> [-dateTimeOriginal <String>] [-isArchived <Boolean>]
