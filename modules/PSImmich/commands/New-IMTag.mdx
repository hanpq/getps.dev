...
```powershell
New-IMTag [[-Session] <ImmichSession>] [-name] <String> [-type] <String> [-ProgressAction <ActionPreference>]
 [<CommonParameters>]
```
...
Defines the type of tag to create.
Valid values, OBJECT, FACE, CUSTOM
