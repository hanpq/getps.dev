---
id: Start-IMAssetJob
title: Start-IMAssetJob
description: Help page for the Powershell "Start-IMAssetJob" command
keywords:
  - Powershell
  - PSImmich
  - Help
...
```powershell
Start-IMAssetJob [[-Session] <ImmichSession>] [-id] <String[]> [-JobName] <String>
