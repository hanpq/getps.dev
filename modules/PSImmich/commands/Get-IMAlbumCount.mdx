---
id: Get-IMAlbumCount
title: Get-IMAlbumCount
description: Help page for the Powershell "Get-IMAlbumCount" command
keywords:
  - Powershell
  - PSImmich
  - Help
...
```powershell
Get-IMAlbumCount [[-Session] <ImmichSession>] [-ProgressAction <ActionPreference>] [<CommonParameters>]
```
