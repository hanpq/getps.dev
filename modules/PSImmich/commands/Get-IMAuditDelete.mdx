---
id: Get-IMAuditDelete
title: Get-IMAuditDelete
description: Help page for the Powershell "Get-IMAuditDelete" command
keywords:
  - Powershell
  - PSImmich
  - Help
...
```powershell
Get-IMAuditDelete [[-Session] <ImmichSession>] [[-userId] <String>] [-after] <DateTime> [-entityType] <String>
