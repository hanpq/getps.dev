---
id: Remove-IMSharedLinkAsset
title: Remove-IMSharedLinkAsset
description: Help page for the Powershell "Remove-IMSharedLinkAsset" command
keywords:
  - Powershell
  - PSImmich
  - Help
...
```powershell
Remove-IMSharedLinkAsset [[-Session] <ImmichSession>] [-Id] <String[]> [-SharedLinkId] <String>
