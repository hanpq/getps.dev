---
id: Find-IMExploreData
title: Find-IMExploreData
description: Help page for the Powershell "Find-IMExploreData" command
keywords:
  - Powershell
  - PSImmich
  - Help
...
```powershell
Find-IMExploreData [[-Session] <ImmichSession>] [-ProgressAction <ActionPreference>] [<CommonParameters>]
```
